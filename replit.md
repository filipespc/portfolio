...
- June 23, 2025: Implemented inline hyperlink functionality using HTML syntax - users can create clickable links by typing `<a href="URL">text</a>` directly in paragraphs. Links automatically display in Sollo red with hover effects in published content. Inline toolbar configuration needs debugging for visual selection method