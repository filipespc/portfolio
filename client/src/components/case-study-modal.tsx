          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="text-xs text-gray-500 bg-gray-50 px-2 py-1 rounded mb-2">
                ...
                <br />• Use the Link tool from sidebar for link cards
                <br />• For inline text links, type: &lt;a href="URL"&gt;text&lt;/a&gt;
                <br />• Example: "explore this idea along with my wife (who is a &lt;a href="https://example.com"&gt;Product Designer&lt;/a&gt;)"
              </div>
            </div>
