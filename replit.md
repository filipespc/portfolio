...
- June 23, 2025: Successfully implemented inline hyperlink functionality - users can now select text and convert it to clickable links using the 🔗 icon in the inline toolbar or Cmd+L keyboard shortcut. Links display in Sollo red with hover effects in published content