...
- June 23, 2025: Implemented inline hyperlink functionality using markdown syntax - users can create clickable links by typing `[text](URL)` directly in paragraphs. Direct URLs are also automatically converted to clickable links. Links display in Sollo red with hover effects in published content